...
export default {
    ...
    <section class = "articleTemplate modalForm">
      <div class = "modalContent articleModal">
        ...
        <div class = "article-header">
          ...
          <div class = "btnWrap">
            <button class = "article-btn editBtn"><i class="bi bi-pencil"></i>수정하기</button>
            <button class = "article-btn chatBtn"><i class="bi bi-chat-dots"></i>채팅하기</button>
          </div>
        </div>
      </div>
    </section>
  ...
  listDetailContent() {
    ...
    <div class = "article-content">
      <span class = "articleTitle">강남요양병원 봉사자 모집</span>
      <p>분야 : 미용봉사 (커트)</p>
      <p>인원수 : 1명</p>
    ...
    `
    sel.el('.article-header').insertAdjacentHTML('afterend', template)
  },
